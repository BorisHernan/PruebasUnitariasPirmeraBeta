...
public class EmpleadoRepositoryTests {
    ...
    @DisplayName("Test para guardar un funcionario")
    @Test
    ...
    @DisplayName("Test para listar a los funcionarios")
    @Test
    ...
    @DisplayName("Test para obtener un funcionario por ID")
    @Test
    ...
    @DisplayName("Test para actualizar un funcionario")
    @Test
    ...
    @DisplayName("Test para eliminar un funcionario")
    @Test
